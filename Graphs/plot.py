...
df1= pandas.DataFrame.from_csv('/home/pinar/Desktop/DATA/ALL_DATA/HOTS/HOTS1.csv')
x = df1.Temp
y = df1.Flour
...
p.scatter(x,y, radius=0.2, fill_color="#FA5858", fill_alpha=0.6, line_color=None)
